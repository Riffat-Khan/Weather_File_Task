class temperature_display:
  ...
  def avg_max_temp(self):
    for each_array in self.data:
      each_avg_max_temp = int(each_array.get('Data.Temperature.Max Temp'))
  ...
  def avg_min_temp(self):
    for each_array in self.data:
      each_avg_min_temp = int(each_array.get('Data.Temperature.Min Temp'))
  ...
  def avg_wind_direction(self):
    for each_array in self.data:
      each_wind_direction = int(each_array.get('Data.Wind.Direction'))
  ...
  def avg_wind_speed(self):
    for each_array in self.data:
      eachWindSpeed = float(each_array.get('Data.Wind.Speed'))
